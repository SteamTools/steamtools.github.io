...
<head>
	<meta charset="UTF-8">
	<meta name="description" content="A set of Steam related WebApps built around trading cards, emoticons and backgrounds. They allow you to view, sort and filter the up-to-date list of items.">
	<meta name="keywords" content="Steam,trading,emoticon,background,card,mosaticon,items,value,price,filter,sort,mosaic">
	<meta name="author" content="Ehsan Kia">
	<title>Steam Tools Hub</title>
...
<body>
	...
	<div id="affiliates">
		Affiliates:
		<a target="_blank" href="http://steamrank.net/">SteamCollectors</a>
		<a target="_blank" href="http://steamsignature.com/">SteamSignature</a>
	</div>

	<svg class="logo" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		 width="250px" height="130px" viewBox="417.5 106.5 2252 1172" style="enable-background:new 417.5 106.5 2252 1172;"
		 xml:space="preserve">
	...
	<ul class="grid cs-style-3">
		<li>
			<figure>
				<div class="c1">Trading Cards</div>
				<figcaption>
					<span>All the stats you could need about Steam trading card sets, kept up to date.</span>
					<a href="cards" alt="Trading Cards">Check it out!</a>
				</figcaption>
			</figure>
		</li>
		<li>
			<figure>
				<div class="c2">Emoticons</div>
				<figcaption>
					<span>Easily browse, filter and sort an up to date list of Steam emoticons in one page.</span>
					<a href="emoticons" alt="Emoticons">Check it out!</a>
				</figcaption>
			</figure>
		</li>
		<li>
			<figure>
				<div class="c3">Backgrounds</div>
				<figcaption>
					<span>Easily browse, filter and sort an up to date list of Steam backgrounds in one page.</span>
					<a href="backgrounds" alt="Backgrounds">Check it out!</a>
				</figcaption>
			</figure>
		</li>
		<li>
			<figure>
				<div class="c4">Mosaticon</div>
				<figcaption>
					<span>Generate a mosaic of your chosen image using the Steam emoticons you own.</span>
					<a href="mosaticon" alt="Mosaticon">Check it out!</a>
				</figcaption>
			</figure>
		</li>
		<li>
			<figure>
				<div class="c5">Games Filter</div>
				<figcaption>
					<span>View the intersection of user's Steam games and filter them by various categories.</span>
					<a href="games" alt="Game Filter">Check it out!</a>
				</figcaption>
			</figure>
		</li>
		<li>
			<figure>
				<div class="c6">Item Value Sorter</div>
				<figcaption>
					<span>Load your Steam Community items and sort them by market value or filter them by type.</span>
					<a href="itemvalue" alt="Item Value">Check it out!</a>
				</figcaption>
			</figure>
		</li>
	</ul>
	...
	<footer id="copyright">
		<div class="rightbar" style="display: inline-block; text-align: right;">
			Website by <a target="_blank" href="http://ehsankia.com">Ehsan Kia</a><br>
			<a target="_blank" href="http://steam.tools">steam.tools</a> &copy; 2013-2014
		</div>
		<div style="display: inline-block; text-align: left;">
			Powered by <a target="_blank" href="http://steampowered.com">Steam</a><br>
			All Rights Reserved
		</div>
	</footer>
</body>
